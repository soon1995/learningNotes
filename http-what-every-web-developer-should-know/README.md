...
Else, the server can respond with a 304 - Not Modified Message
...
Another security concern around cookies: vulnerable to XSS.

1. A malicious user injects malevolent JavaScript code into someone else's website.
