// ex3.3: color each polygon based on its height, so that the peaks
// are colored red (#ff0000) and valleys blue (#0000ff)
package main
...
func main() {
	cornersvg, _ := os.OpenFile("corner.svg", os.O_WRONLY|os.O_TRUNC|os.O_CREATE, 0666)
	Surface(cornersvg, f)
	cornersvg.Close()
